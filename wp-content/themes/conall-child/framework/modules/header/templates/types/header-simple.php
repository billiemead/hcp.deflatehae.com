                                ...
                                <div class="edgtf-grid">
                                    <div class="menu-selector-box left">
                                        <li class="menu-selector-list-item">
                                            <span class="menu-selector-link yellow">For healthcare professionals</span>
                                        </li>
                                    ...
                                    <div class="menu-selector-box right">
                                        <li class="menu-selector-list-item">
                                            <a class="menu-selector-link white exitNotifierLink" href="https://deflatehae.com/" target="_blank">For people with HAE and caregivers</a>
                                        </li>
