...
if (!class_exists('VC_Extensions_CoverFlow')){
    class VC_Extensions_CoverFlow{
        ...
        function __construct() {
            vc_map(array(
            "name" => esc_attr__("Coverflow with lightbox", 'cq_allinone_vc'),
      ...
      function cq_vc_coverflow_func($atts, $content=null) {
        ...
        wp_register_script('vc-extensions-coverflow-script', plugins_url('js/init.min.js', __FILE__), array("jquery", "cq-swiper", "tooltipster"));
