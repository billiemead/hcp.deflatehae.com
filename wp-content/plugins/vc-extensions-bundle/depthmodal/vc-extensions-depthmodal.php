...
if (!class_exists( 'VC_Extensions_DepthModal' ) ) {
    ...
    function cq_vc_modal_func( $atts, $content=null, $tag=null) {
        ...
        function cq_vc_notify_func( $atts, $content=null, $tag=null) {
          extract( shortcode_atts( array(
            'width' => '240',
            'height' => '140',
            'textcolor' => '#333',
        ...
        function cq_vc_gallery_func( $atts, $content=null, $tag=null) {
          global $post;
          extract( shortcode_atts( array(
            'images' => '',
            'itemwidth' => '240',
