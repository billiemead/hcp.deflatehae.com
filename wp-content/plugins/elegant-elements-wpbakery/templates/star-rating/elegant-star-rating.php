<?php
$html = '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-star-rating' ) . ' itemscope>';
...
for ( $i = 0; $i < $this->args['rating_scale']; $i++ ) {
	...
	$html .= '<i ' . Elegant_Elements_WPBakery::attributes( 'elegant-star-rating-item', $args ) . '>';
