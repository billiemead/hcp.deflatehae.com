...
$html  = '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-animated-divider' ) . '>';
$html .= '<div style="background: ' . $background_color_top . ';"></div>';
$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-animated-divider-block' ) . '></div>';
