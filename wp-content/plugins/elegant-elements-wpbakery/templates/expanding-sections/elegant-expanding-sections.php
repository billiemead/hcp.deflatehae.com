<?php
$html = '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-sections' ) . '>';

$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-heading-area' ) . '>';

$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-heading-wrapper' ) . '>';
$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-title' ) . '>';
$html .= '<h2>' . $this->args['title'] . '</h2>';
$html .= '</div>'; // elegant-expanding-section-title.

if ( '' !== trim( $this->args['description'] ) ) {
	$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-description' ) . '>';
...
$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-icon' ) . '>';
...
$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-content-area' ) . '>';
$html .= '<div ' . Elegant_Elements_WPBakery::attributes( 'elegant-expanding-section-content' ) . '>';
