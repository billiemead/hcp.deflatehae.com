...
Tags: external image upload, image grab, media grab, media upload, remote image grab, Remote Image Upload, remote media grab, Remote Upload, wordpress media grabber, wordpress remote upload, wp auto grab image, wp image upload, wp remote upload, image, post, widget , admin 
Requires at least: 4
Tested up to: 5.0
Stable tag: 0.4
...
[youtube https://www.youtube.com/watch?v=fLYSZpOHXCY]
...
* Removed depriciated function

= 0.2 =

* Removed url filter
* File size was not displaying : FIXED
