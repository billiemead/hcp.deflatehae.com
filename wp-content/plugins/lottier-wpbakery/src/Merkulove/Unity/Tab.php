...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'LottierWpbakery' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'LottierWpbakery' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'LottierWpbakery' . $tab_slug . 'OptionsGroup', 'mdp_lottier_wpbakery_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_lottier_wpbakery_' . $tab_slug . '_page_status_section', '', null, 'LottierWpbakery' . $tab_slug . 'OptionsGroup' );
    ...
    public static function add_settings_tab(
        ...
        $new_tab = array(
            'enabled'       => true,
            'class'         => $class,
            'label'         => $label ?? esc_html__( 'Tab', 'lottier-wpbakery' ),
            'title'         => $title ?? esc_html__( 'Tab', 'lottier-wpbakery' ),
