...
final class PluginHelper {
	...
	public function add_row_meta( $links, $file ) {
		...
		$stars = esc_html__( 'Rate this plugin:', 'lottier-wpbakery' );
    ...
    public static function load_textdomain() {
        ...
        load_plugin_textdomain( 'lottier-wpbakery', false, Plugin::get_path() . '/languages/' );
