...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/lottier-wpbakery.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'appearance_page_mdp_lottier_wpbakery_settings';
            self::$menu_bases[] = 'elementor_page_mdp_lottier_wpbakery_settings';
            self::$menu_bases[] = 'settings_page_mdp_lottier_wpbakery_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_lottier_wpbakery_settings';
            self::$menu_bases[] = 'lottier_wpbakery_page_mdp_lottier_wpbakery_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'General Settings', 'lottier-wpbakery' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'Custom CSS', 'lottier-wpbakery' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'lottier-wpbakery' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'Assignments Settings', 'lottier-wpbakery' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'Plugin Activation', 'lottier-wpbakery' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'System Status', 'lottier-wpbakery' ),
            'show_title'    => true,
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'Updates', 'lottier-wpbakery' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
    ...
    private function add_migration_tab() {
        ...
        self::$tabs['migration'] = [
            ...
            'label'         => esc_html__( 'Migration', 'lottier-wpbakery' ),
            'title'         => esc_html__( 'Migration Settings', 'lottier-wpbakery' ),
            'show_title'    => true,
            'icon'          => 'multiple_stop',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'lottier-wpbakery' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'lottier-wpbakery' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'lottier-wpbakery' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/lottier-wpbakery.php';
