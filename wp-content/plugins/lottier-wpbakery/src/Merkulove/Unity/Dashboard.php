...
final class Dashboard {
		...
		if ( 'dashboard' === $screen->base ) {
			...
			wp_localize_script(
				...
				[
                    ...
                    'translation' => array(
                        'licenseActive'     => esc_html__( 'Licensed', 'lottier-wpbakery' ),
                        'licenseInactive'   => esc_html__( 'No license', 'lottier-wpbakery' ),
                        'licenseUnknown'    => esc_html__( 'No licence data', 'lottier-wpbakery' ),
                        'wait'              => esc_html__( 'Wait', 'lottier-wpbakery' ),
                    )
				]
			);
	...
	public function unity_dashboard_setup() {
		...
		wp_add_dashboard_widget(
			...
			esc_html__( 'Plugins Manager', 'lottier-wpbakery' ),
	...
	private function header_markup( ): string {
		...
		return wp_sprintf(
            ...
            esc_html__( 'Explore more plugins', 'lottier-wpbakery' ),
			esc_html__( 'opens in a new window', 'lottier-wpbakery' )
		);
    ...
    private function plugin_status_markup( $slug, $plugin ): string {
        ...
        $license_status = wp_sprintf(
	        ...
	        esc_html__( 'Plugin licence status', 'lottier-wpbakery' )
        );
        ...
        $update_status = wp_sprintf(
	        ...
	        esc_html__( 'Update to', 'lottier-wpbakery' ),
	        esc_html__( 'Latest', 'lottier-wpbakery' ),
    ...
    private function plugin_buttons_markup( $plugin, $is_activated ): string {
        ...
        $activation_button = wp_sprintf(
            ...
            esc_html__( 'Activate', 'lottier-wpbakery' )
        );
        ...
        return wp_sprintf(
	        ...
	        $settings_url,
	        esc_html__( 'Settings', 'lottier-wpbakery' ),
