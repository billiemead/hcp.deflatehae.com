...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'lottier-wpbakery' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'lottier-wpbakery' ),
			'site_url'              => esc_html__( 'Site URL', 'lottier-wpbakery' ),
			'home_url'              => esc_html__( 'Home URL', 'lottier-wpbakery' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'lottier-wpbakery' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'lottier-wpbakery' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'lottier-wpbakery' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'lottier-wpbakery' ),
			'language'              => esc_html__( 'Language', 'lottier-wpbakery' ),
			'timezone'              => esc_html__( 'Timezone', 'lottier-wpbakery' ),
			'admin_email'           => esc_html__( 'Admin Email', 'lottier-wpbakery' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'lottier-wpbakery' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'lottier-wpbakery' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'lottier-wpbakery' ) : esc_html__( 'No', 'lottier-wpbakery' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'lottier-wpbakery' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'lottier-wpbakery' ) : esc_html__( 'Inactive', 'lottier-wpbakery' )
		];
