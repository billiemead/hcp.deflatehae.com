...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpLottierWpbakery = window.mdpLottierWpbakeryUnity;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpLottierWpbakery.restBase }lottier-wpbakery/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_lottier_wpbakery',
                nonce: mdpLottierWpbakery.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpLottierWpbakery.ajaxURL, data, function( response ) {
         ...
         * @param pid
         *
         * @param window.mdpLottierWpbakeryUnity.translation.pidErrorElements
         * @param window.mdpLottierWpbakeryUnity.translation.pidErrorInvoice
         * @param window.mdpLottierWpbakeryUnity.translation.pidErrorOrder
         * @param window.mdpLottierWpbakeryUnity.translation.pidError
         * @returns {boolean}
         */
        function pidValidator( $helper, pid ) {
            ...
            const { translation } = window.mdpLottierWpbakeryUnity;
