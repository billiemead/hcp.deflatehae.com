...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/lottier-wpbakery/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpLottierWpbakeryUnity;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'lottier-wpbakery-settings.json'
                ...
                xhr.send(`action=export_settings_lottier_wpbakery&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_lottier_wpbakery&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);
